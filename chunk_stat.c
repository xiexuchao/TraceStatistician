...
void main()
{
	//run("UMNtrace1_10.csv","UMNtrace1_10.txt");
	//run("UMNtrace1_13.csv","UMNtrace1_13.txt");
	//run("UMNtrace2_1.csv","UMNtrace2_1.txt");
	//run("UMNtrace2_5.csv","UMNtrace2_5.txt");
	//run("UMNtrace3_14.csv","UMNtrace3_14.txt");
	//run("UMNtrace3_15.csv","UMNtrace3_15.txt");
	run("hm_0.csv","777.txt");
	//run("mds_0.csv","777.txt");
	/*run("prn_0.csv","win_prn_0.txt");
	run("proj_0.csv","win_proj_0.txt");*/
}
...
void init(struct pool_info *pool,char *trace,char *output)
{
	...
	memset(pool->win_chk_acs,0,sizeof(int)*10000);
	memset(pool->win_req_acs,0,sizeof(int)*10000);

	memset(pool->sorted_reqs,0,sizeof(unsigned int)*10000);
	memset(pool->sorted_size,0,sizeof(unsigned int)*10000);
